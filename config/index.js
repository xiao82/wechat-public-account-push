export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxe638756f2676ecee",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "d60957bccf0b5f360127b21dc4913cbe",
   ...
   */
  USERS: ("ok8om6G4TIxbyIGxYgTNIWHFLgI0"),
    {
      // 想要发送的人的名字
      name: "老婆0",
      // 扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      id: "ok8om6G4TIxbyIGxYgTNIWHFLgI0",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "emaLzUkcy0JaCMzTwqz1LZc-3COocise_l2rmLzdyFM",
      // 所在省份
      province: "贵州",
      // 所在城市
      city: "贵阳",
      ...
      festivals: [
        ...
        {"type": "*生日", "name": "老婆", "year": "2001", "date": "08-24"},
        // 注意：此条配置日期为阳历日期，因为`type`中 “生日” 之前没有 * 符号
        {"type": "生日", "name": "乖乖", "year": "2001", "date": "09-18"},
        {"type": "节日", "name": "被搭讪纪念日", "year": "2022", "date": "04-06"},
      ],
